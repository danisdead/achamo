(window._gsQueue || (window._gsQueue = [])).push(function () {
        ...
        r = function (r) {
            ...
            if ("hsl" === r.substr(0, 3)) {
                ...
                var s = Number(r[0]) % 360 / 360,
                    ...
                    a = .5 >= u ? u * (o + 1) : u + o - u * o,
                    f = 2 * u - a;
                return r.length > 3 && (r[3] = Number(r[3])), r[0] = n(s + 1 / 3, f, a), r[1] = n(s, f, a), r[2] = n(s - 1 / 3, f, a), r
            }
    ...
    window._gsDefine.plugin({
        ...
        init: function (e, t) {
            this._target = e;
            var n, i, o, u;
            for (n in t) o = r(t[n]), this._firstPT = u = {
                _next: this._firstPT,
                p: n,
                f: "function" == typeof e[n],
                n: n,
                r: !1
            }, i = r(u.f ? e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : e[n]), u.s = Number(i[0]), u.c = Number(o[0]) - u.s, u.gs = Number(i[1]), u.gc = Number(o[1]) - u.gs, u.bs = Number(i[2]), u.bc = Number(o[2]) - u.bs, (u.rgba = i.length > 3 || o.length > 3) && (u.as = 4 > i.length ? 1 : Number(i[3]), u.ac = (4 > o.length ? 1 : Number(o[3])) - u.as), u._next && (u._next._prev = u);
            return !0
        },
        set: function (e) {
            for (var t, n = this._firstPT; n;) t = (n.rgba ? "rgba(" : "rgb(") + (n.s + e * n.c >> 0) + ", " + (n.gs + e * n.gc >> 0) + ", " + (n.bs + e * n.bc >> 0) + (n.rgba ? ", " + (n.as + e * n.ac) : "") + ")", n.f ? this._target[n.p](t) : this._target[n.p] = t, n = n._next
        }
    })
    ...
    var t = function (e, n, r, i, s, o) {
            ...
            this.onMouseOver = function (e) {
                if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                    ...
                    TweenMax.to(u.n1_do, .8, {
                        alpha: 0,
                        ease: Expo.easeOut
                    });
                    TweenMax.to(u.n2_do, .8, {
                        alpha: 0,
                        ease: Expo.easeOut
                    })
                }
...
(function (e) {
    var t = function (e, t, n, r) {
            ...
            this.setY = function (e) {
                ...
                if (i.isMobile_bl) {
                    i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px)"
                } else if (i.hasTransform3d_bl && !FWDUtils.isAndroid) {
                    i.screen.style[i.transform] = "translate3d(" + i.x + "px," + i.y + "px,0)"
                } else if (i.hasTransform2d_bl) {
                    i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px)"
                } else {
...
(function (e) {
    var t = function (e, t, n, r) {
            ...
            this.setMainProperties = function () {
                ...
                if (i.opacityType == "filter") i.screen.style.filter = "inherit";
                this.screen.style.left = "0px";
                this.screen.style.top = "0px"; //fotos carousel
                this.screen.style.margin = "0px";
                this.screen.style.padding = "0px";
                this.screen.style.maxWidth = "none";
                this.screen.style.maxHeight = "none";
...
(function (e) {
    var t = function (n) {
            ...
            this.setupPreloader = function () {
                ...
                this.preloader_do = new FWDPreloader(this.preloaderImg, 85, 36, 20, 50);
            ...
            this.hide = function () {
                ...
                if (this.type_str == t.YOUTUBE || this.type_str == t.VIMEO || r.type_str == t.IFRAME) {
                    ...
                    if (this.currentItem_do && this.currentItem_do.screen) {
                        TweenMax.killTweensOf(this.currentItem_do);
                        TweenMax.to(this.currentItem_do, .7, {
                            alpha: 0,
                            ease: Quint.easeOut
                        })
                    }
...
(function () {
    var e = function (t, n, r, i, s) {
            ...
            this.setupMainContainers = function () {
                o.bkDO = new FWDSimpleDisplayObject("div");
                o.addChild(o.bkDO);
                o.textDO = new FWDSimpleDisplayObject("div");
                o.textDO.getStyle().whiteSpace = "nowrap";
                o.textDO.setBackfaceVisibility();
                o.textDO.setOverflow("visible");
                o.textDO.setDisplay("inline-block");
                o.textDO.getStyle().fontFamily = "Arial";
                o.textDO.getStyle().fontSize = "13px";
                o.textDO.getStyle().padding = "6px";
                ...
                o.addChild(o.textDO);
                o.dumyDO = new FWDSimpleDisplayObject("div");
                if (FWDUtils.isIE) {
            ...
            this.onMouseOver = function (e) {
                ...
                if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                    TweenMax.killTweensOf(o.textDO);
            ...
            this.destroy = function () {
                ...
                TweenMax.killTweensOf(o.textDO.screen);
                TweenMax.killTweensOf(o.bkDO.screen);
                o.textDO.destroy();
                o.bkDO.destroy();
                o.dumyDO.destroy();
                o.bkDO = null;
...
(function (e) {
    var t = function (n, r, i, s, o, u, a, f) {
            ...
            this.init = function () {
                l.setZ(2e5);
                l.buttonsHolderDO = new FWDDisplayObject("div");
            ...
            this.onMouseMove = function (e) {
                ...
                TweenMax.to(l.buttonsHolderDO, .2, {
                    x: Math.floor(r)
                })
            };
    ...
    t.setPrototype = function () {
        t.prototype = new FWDDisplayObject3D("div")
    };
    t.CHANGE = "onChange";
    t.prototype = null;
    ...
    var t = function (e) {
            ...
            this.parseProperties = function () {
                ...
                if (!n.propsObj.coverflowDataListDivId) {
                    e = "Coverflow data list id is not defined in FWD3DCoverflow constructor function!";
                    n.dispatchEvent(t.LOAD_ERROR, {
                        text: e
                    });
                    return
                }
                n.rootElement = FWDUtils.getChildById(n.propsObj.coverflowDataListDivId);
                if (!n.rootElement) {
                ...
                n.gradientDir = n.propsObj.thumbnailGradientDirection;
                ...
                var r = FWDUtils.getChildrenFromAttribute(n.rootElement, "data-cat");
                if (!r) {
                ...
                for (var g = 0; g < i; g++) {
                    ...
                    u = [];
                    o = [];
                    h = FWDUtils.getChildren(f);
                    l = h.length;
                    for (var y = 0; y < l; y++) {
                        var b = {};
                        var w = h[y];
                        var a = FWDUtils.getChildren(w);
                        v = g + 1;
                        m = y + 1;
                        c = a.length;
                        var E = true;
                        for (var S = 0; S < c; S++) {
                            ...
                            if (FWDUtils.hasAttribute(a[S], "data-thumbnail-path")) {
                                E = false;
                                b.thumbPath = FWDUtils.trim(FWDUtils.getAttributeValue(a[S], "data-thumbnail-path"));
                                p = a[S];
                                break
                            }
                        }
                        ...
                        if (FWDUtils.hasAttribute(p, "data-thumbnail-width") && FWDUtils.hasAttribute(p, "data-thumbnail-height")) {
                            b.thumbWidth = parseInt(FWDUtils.trim(FWDUtils.getAttributeValue(p, "data-thumbnail-width")));
                            b.thumbHeight = parseInt(FWDUtils.trim(FWDUtils.getAttributeValue(p, "data-thumbnail-height")))
                        } else {
                        ...
                        if (n.showTooltip || n.showText) {
                            ...
                            for (var S = 0; S < c; S++) {
                                ...
                                if (FWDUtils.hasAttribute(a[S], "data-thumbnail-text")) {
                                    E = false;
                        ...
                        for (var S = 0; S < c; S++) {
                            d = "data-type";
                            if (FWDUtils.hasAttribute(a[S], "data-type")) {
                                E = false;
                                b.mediaType = FWDUtils.trim(FWDUtils.getAttributeValue(a[S], "data-type"));
                                break
                            }
                        }
                        if (E) {
                        ...
                        for (var S = 0; S < c; S++) {
                            d = "data-url";
                            if (FWDUtils.hasAttribute(a[S], "data-url")) {
                                E = false;
                                p = a[S];
                                break
                            }
                        ...
                        var x = {};
                        x.dataType = FWDUtils.trim(FWDUtils.getAttributeValue(p, "data-type"));
                        x.url = FWDUtils.trim(FWDUtils.getAttributeValue(p, "data-url"));
                        x.target = FWDUtils.getAttributeValue(p, "data-target");
                        x.width = FWDUtils.getAttributeValue(p, "data-width");
                        x.height = FWDUtils.getAttributeValue(p, "data-height");
                        x.info = FWDUtils.getAttributeValue(p, "data-info");
                        if (!x.target) x.target = "_blank";
                        for (var S = 0; S < c; S++) {
                            if (FWDUtils.hasAttribute(a[S], "data-info")) {
                    ...
                    n.categoriesAr[g] = FWDUtils.getAttributeValue(f, "data-cat") || "not defined!";
                    n.dataListAr[g] = u;
                    n.lightboxAr[g] = o
                }
                ...
                if (!n.propsObj.skinPath) {
                    n.dispatchEvent(t.LOAD_ERROR, {
                        text: "Coverflow graphics skin path is not defined in FWD3DCoverflow constructor function!"
                    });
                    return
                }
                var T = n.propsObj.skinPath + "/preloader.png";
            ...
            this.checkForAttribute = function (e, r) {
                var i = FWDUtils.getChildFromNodeListFromAttribute(e, r);
...
(function (e) {
    var t = function (n, r, i) {
            ...
            this.setTrack = function () {
                ...
                s.scrollbarTrackRightDO = new FWDSimpleDisplayObject("img");
            ...
            this.setHandler = function () {
                s.scrollbarHandlerDO = new FWDDisplayObject("div");
                ...
                s.scrollbarHandlerCenterNDO = new FWDSimpleDisplayObject("div");
                ...
                s.scrollbarHandlerRightSDO = new FWDSimpleDisplayObject("img");
                ...
                s.scrollbarHandlerRightNDO = new FWDSimpleDisplayObject("img");
                ...
                s.scrollbarHandlerTextDO = new FWDDisplayObject("div");
                ...
                s.scrollbarHandlerOverDO = new FWDDisplayObject("div");
            ...
            this.onScrollMouseOver = function () {
                ...
                TweenMax.to(s.scrollbarHandlerLeftNDO, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                });
                TweenMax.to(s.scrollbarHandlerCenterNDO, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                });
                TweenMax.to(s.scrollbarHandlerRightNDO, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                });
                TweenMax.to(s.scrollbarHandlerTextDO.screen, .8, {
                    css: {
            ...
            this.onScrollMouseDown = function (t) {
                ...
                s.isPressed = true;
                TweenMax.killTweensOf(s.scrollbarHandlerDO);
                if (s.isMobile) {
                    if (s.hasPointerEvent) {
            ...
            this.gotoItem = function (e, t) {
                ...
                if (s.prevCurItemId != s.curItemId) {
                    if (t) {
                        TweenMax.killTweensOf(s.scrollbarHandlerDO);
                        TweenMax.to(s.scrollbarHandlerDO, .8, {
            ...
            this.destroy = function () {
                ...
                TweenMax.killTweensOf(s.scrollbarHandlerLeftNDO);
                TweenMax.killTweensOf(s.scrollbarHandlerCenterNDO);
                TweenMax.killTweensOf(s.scrollbarHandlerRightNDO);
                TweenMax.killTweensOf(s.scrollbarHandlerDO);
                TweenMax.killTweensOf(s.scrollbarHandlerTextDO.screen);
...
(function (e) {
    var t = function (n) {
            ...
            this.setPauseButton = function () {
                r.pauseButtonDO = new FWDSimpleDisplayObject("img");
            ...
            this.setPlayButton = function () {
                r.playButtonDO = new FWDDisplayObject("div");
                r.addChild(r.playButtonDO);
                r.playButtonSDO = new FWDSimpleDisplayObject("img");
                r.playButtonSDO.setScreen(r.playButtonSImg);
                r.playButtonDO.addChild(r.playButtonSDO);
                r.playButtonNDO = new FWDSimpleDisplayObject("img");
            ...
            this.onMouseOver = function () {
                if (r.isPlaying) {
                    TweenMax.to(r.timerButtonDO, .8, {
                        alpha: 0,
                        ease: Expo.easeOut
                    })
                } else {
                    TweenMax.to(r.playButtonNDO, .8, {
                        alpha: 0,
                        ease: Expo.easeOut
                    })
                }
            ...
            this.destroy = function () {
                ...
                TweenMax.killTweensOf(r.timerButtonDO);
                TweenMax.killTweensOf(r.playButtonNDO);
...
(function (e) {
    var t = function (e, n, r) {
            ...
            this.setupScreen = function () {
                i.mainDO = new FWDDisplayObject("div", "absolute", "visible");
                i.addChild(i.mainDO);
                ...
                if (!n.transparentImages) {
                    i.borderDO = new FWDSimpleDisplayObject("div");
                    i.bgDO = new FWDSimpleDisplayObject("div");
                ...
                i.imageHolderDO = new FWDDisplayObject("div");
            ...
            this.setupTooltip = function () {
                FWDTooltip.setPrototype();
                i.tooltipDO = new FWDTooltip({
            ...
            this.addReflection = function () {
                if (!i.imageDO || i.isMobile || FWDUtils.isIEAndLessThen9) return;
                var e = i.thumbWidth - i.borderSize * 2;
                var t = i.thumbHeight - i.borderSize * 2;
                i.reflCanvasDO = new FWDSimpleDisplayObject("canvas");
            ...
            this.addImage = function (e) {
                i.imageDO = new FWDSimpleDisplayObject("img");
            ...
            this.setupGradient = function () {
                if (i.isMobile || FWDUtils.isIEAndLessThen10 || !r.showGradient) return;
                i.gradientDO = new FWDDisplayObject("div");
                i.mainDO.addChild(i.gradientDO);
                i.gradientDO.setWidth(i.thumbWidth);
                if (r.showRefl && !i.isMobile && !FWDUtils.isIEAndLessThen10) {
                    i.gradientDO.setHeight(i.thumbHeight + r.reflDist + r.reflHeight)
                } else {
                    i.gradientDO.setHeight(i.thumbHeight)
                }
                i.gradientLeftDO = new FWDSimpleDisplayObject("div");
                ...
                i.gradientLeftDO.setCSSGradient(r.gradientDir, r.gradientColor1, r.gradientColor2);
                i.gradientRightDO = new FWDSimpleDisplayObject("div");
                ...
                if (r.topology == "onesided" || r.topology == "frontonesided") {
                    i.gradientRightDO.setCSSGradient(r.gradientDir, r.gradientColor1, r.gradientColor2)
                } else {
                    i.gradientRightDO.setCSSGradient(r.gradientDir, r.gradientColor2, r.gradientColor1)
                }
                i.gradientLeftDO.setAlpha(0);
                i.gradientRightDO.setAlpha(0)
            };
            this.setGradient = function (e) {
                if (i.gradPos == e) return;
                i.gradPos = e;
                if (!i.isMobile && !FWDUtils.isIEAndLessThen10 && r.showGradient) {
                    switch (i.gradPos) {
                    case 0:
                        TweenMax.to(i.gradientLeftDO, .8, {
                            alpha: 0
                        });
                        TweenMax.to(i.gradientRightDO, .8, {
                            alpha: 0,
            ...
            this.destroy = function () {
                ...
                TweenMax.killTweensOf(i.mainDO);
                ...
                if (i.imageDO) {
                    TweenMax.killTweensOf(i.imageDO);
                ...
                if (i.borderDO) {
                    TweenMax.killTweensOf(i.borderDO);
                    i.borderDO.destroy();
                    i.borderDO = null
                }
                if (i.gradientLeftDO) {
                    TweenMax.killTweensOf(i.gradientLeftDO);
                    i.gradientLeftDO.destroy()
                }
                if (i.gradientRightDO) {
                    TweenMax.killTweensOf(i.gradientRightDO);
                    i.gradientRightDO.destroy()
                }
                if (i.textGradientDO) {
                    TweenMax.killTweensOf(i.textGradientDO);
                    i.textGradientDO = null
                }
                if (i.textDO) {
                    TweenMax.killTweensOf(i.textDO);
                    i.textDO = null
                }
                if (i.textHolderDO) {
                    TweenMax.killTweensOf(i.textHolderDO);
                    i.textHolderDO = null
                }
    ...
    t.setPrototype = function () {
        t.prototype = new FWDDisplayObject3D("div", "absolute", "visible")
    };
    t.CLICK = "click";
    t.prototype = null;
    e.FWDS3DCovThumb = t
...
(function (e) {
    var t = function (n, r) {
            ...
            this.sizeRatio = i.thumbWidth / 200;
            ...
            this.gradientDir = n.gradientDir;
            ...
            this.showControlsId;
            this.init = function () {
                i.thumbsHolderDO = new FWDDisplayObject3D("div", "absolute", "visible");
                ...
                if (!i.isMobile && !FWDUtils.isSafari || FWDUtils.isAndroidAndWebkit) {
            ...
            this.showCurrentCat = function (e) {
                ...
                switch (i.data.coverflowStartPosition) {
                case "left":
                    i.curId = 0;
                    break;
                case "right":
                ...
                for (var t = 0; t < i.totalThumbs; t++) {
                    if (i.curDataListAr[t].thumbHeight > i.thumbsMaxHeight) {
                        i.thumbsMaxHeight = i.curDataListAr[t].thumbHeight
                    }
                }
                i.setupThumbs();
                i.prevCurId = i.curId;
                ...
                for (var e = 0; e < i.totalThumbs; e++) {
                    ...
                    if (e == i.curId) {
                        ...
                        if (i.isMobile && i.textHolderDO) {
                            TweenMax.to(i.textHolderDO, .6, {
                                alpha: 0,
                                delay: .2,
                                ease: Expo.easeOut
                            });
                            TweenMax.to(i.textGradientDO, .6, {
                                alpha: 0,
                                delay: .2,
                                ease: Expo.easeOut
                            })
            ...
            this.thumbClickHandler = function () {
                if (i.curId != i.prevCurId) {
                    ...
                    if (n != "link") {
                        for (var s = 0; s < i.totalThumbs; s++) {
                            if (s < i.curId && i.curDataListAr[s].mediaType == "link") {
                                r -= 1
                            }
                        }
                    }
            ...
            this.resizeHandler = function () {
                ...
                if (i.textDO) {
                    ...
                    i.textDO.setY(Math.floor(i.stageHeight / 2 + i.thumbHeight / 2 + i.textOffset))
                }
            };
            this.setupText = function () {
                i.textDO = new FWDSimpleDisplayObject("div");
                i.addChild(i.textDO);
                ...
                i.textDO.setX(Math.floor((i.stageWidth - i.thumbWidth) / 2));
                i.textDO.setY(Math.floor(i.stageHeight / 2 + i.thumbsMaxHeight / 2 + i.textOffset))
            };
            ...
            this.loadImages = function () {
                if (FWDUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                    i.setupIntro3D()
                } else {
                    i.setupIntro2D()
                }
            ...
            this.setupIntro3D = function () {
                        ...
                        if (a != i.curId) {
                            if (i.nrThumbsToDisplay > 0 && Math.abs(a - i.curId) <= i.nrThumbsToDisplay) {
                                if (Math.abs(a - i.curId) % 2 == 0) {
                                    e = i.thumbWidth * 3 / 8 * Math.abs(a - i.curId) * f;
                                    n = -i.thumbWidth * Math.sqrt(3) / 8 * Math.abs(a - i.curId);
                                    s = 0
                                } else {
                                    e = (i.thumbWidth * 3 / 8 * (Math.abs(a - i.curId) - 1) + i.thumbWidth * 3 / 8) * f;
                                    n = -i.thumbWidth * Math.sqrt(3) / 8 * Math.abs(a - i.curId);
                                    s = 60 * f
                                }
                            } else {
                                if (i.nrThumbsToDisplay > 0) {
                                    ...
                                    s = -i.thumbYAngle3D * f;
                                    if (Math.abs(a - i.curId) % 2 == 0) {
                                        e = i.thumbWidth * 3 / 8 * (i.nrThumbsToDisplay + 1) * f;
                                        n = -i.thumbWidth * Math.sqrt(3) / 8 * (i.nrThumbsToDisplay + 1);
                                        s = 0
                                    } else {
                                        e = (i.thumbWidth * 3 / 8 * (i.nrThumbsToDisplay + 1 - 1) + i.thumbWidth * 3 / 8) * f;
                                        n = -i.thumbWidth * Math.sqrt(3) / 8 * (i.nrThumbsToDisplay + 1);
                                        s = 60 * f
                                    }
                                    o = 0
                ...
                if (FWDUtils.isIEAndMoreThen9 || !FWDUtils.hasTransform3d || i.data.showDisplay2DAlways) {
                    i.sortZ()
                }
            ...
            this.gotoThumb3D = function () {
                ...
                for (var u = 0; u < i.totalThumbs; u++) {
                    ...
                    if (u == i.curId && i.showRefl) {
                        thumb.updateRefl(true)
                    }
                    switch (i.topology) {
                    case "onesided":
                        if (u != i.curId) {
                            if (i.nrThumbsToDisplay > 0 && Math.abs(u - i.curId) <= i.nrThumbsToDisplay) {
                                e = i.thumbXSpace3D * Math.abs(u - i.curId) + i.thumbXOffset3D;
                                if (u < i.curId) {
                                    n = -((i.thumbZSpace3D + 1) * (u - i.curId) - i.thumbZOffset3D)
                                } else {
                                    n = -((i.thumbZSpace3D + 1) * (u - i.curId) + i.thumbZOffset3D)
                                }
                                s = -i.thumbYAngle3D * a
                                ...
                                if (i.nrThumbsToDisplay > 0) {
                                    e = i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D;
                                    if (u < i.curId) {
                                        n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) * a - i.thumbZOffset3D)
                                    } else {
                                        n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) * a + i.thumbZOffset3D)
                                    }
                                    s = -i.thumbYAngle3D * a;
                    ...
                    case "acordeon":
                        if (u != i.curId) {
                            if (i.nrThumbsToDisplay > 0 && Math.abs(u - i.curId) <= i.nrThumbsToDisplay) {
                                if (Math.abs(u - i.curId) % 2 == 0) {
                                    e = i.thumbWidth * 3 / 8 * Math.abs(u - i.curId) * a;
                                    n = -i.thumbWidth * Math.sqrt(3) / 8 * Math.abs(u - i.curId);
                                    s = 0
                                } else {
                                    e = (i.thumbWidth * 3 / 8 * (Math.abs(u - i.curId) - 1) + i.thumbWidth * 3 / 8) * a;
                                    n = -i.thumbWidth * Math.sqrt(3) / 8 * Math.abs(u - i.curId);
                                    s = 60 * a
                                }
                            } else {
                                if (i.nrThumbsToDisplay > 0) {
                                    ...
                                    s = -i.thumbYAngle3D * a;
                                    if (Math.abs(u - i.curId) % 2 == 0) {
                                        e = i.thumbWidth * 3 / 8 * (i.nrThumbsToDisplay + 1) * a;
                                        n = -i.thumbWidth * Math.sqrt(3) / 8 * (i.nrThumbsToDisplay + 1);
                                        s = 0
                                    } else {
                                        e = (i.thumbWidth * 3 / 8 * (i.nrThumbsToDisplay + 1 - 1) + i.thumbWidth * 3 / 8) * a;
                                        n = -i.thumbWidth * Math.sqrt(3) / 8 * (i.nrThumbsToDisplay + 1);
                                        s = 60 * a
                                    }
                                    o = 0
                    ...
                    default:
                        if (u != i.curId) {
                            if (i.nrThumbsToDisplay > 0 && Math.abs(u - i.curId) <= i.nrThumbsToDisplay) {
                                e = (i.thumbXSpace3D * Math.abs(u - i.curId) + i.thumbXOffset3D) * a;
                                n = -((i.thumbZSpace3D + 1) * Math.abs(u - i.curId) + i.thumbZOffset3D);
                                s = -i.thumbYAngle3D * a
                            } else {
                                if (i.nrThumbsToDisplay > 0) {
                                    e = (i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D) * a;
                                    n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) + i.thumbZOffset3D);
                                    s = -i.thumbYAngle3D * a;
                                    o = 0
                                } else {
                    ...
                    n *= i.sizeRatio;
                    if (i.data.thumbsAlignment == "bottom") {
                        e = Math.floor(e) - Math.floor(i.curDataListAr[u].thumbWidth / 2);
                        t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[u].thumbHeight)
                    } else {
                        e = Math.floor(e) - Math.floor(i.curDataListAr[u].thumbWidth / 2);
                        t = Math.floor(t) - Math.floor(i.curDataListAr[u].thumbHeight / 2)
                    }
            ...
            this.gotoThumb2D = function () {
                ...
                for (var r = 0; r < i.totalThumbs; r++) {
                    ...
                    if (Math.abs(r - i.curId) <= i.nrThumbsToDisplay) {
                        if (r != i.curId) {
                            n = Math.max(.9 - Math.abs(r - i.curId) * .05, .25);
                            e = (i.thumbXSpace2D * Math.abs(r - i.curId) + i.thumbXOffset2D) * s;
                            e *= i.sizeRatio
                        }
                        if (i.data.thumbsAlignment == "bottom") {
                            e = Math.floor(e) - Math.floor(i.curDataListAr[r].thumbWidth / 2);
                            t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[r].thumbHeight)
                        } else {
                            e = Math.floor(e) - Math.floor(i.curDataListAr[r].thumbWidth / 2);
                            t = Math.floor(t) - Math.floor(i.curDataListAr[r].thumbHeight / 2)
                        }
                        thumb.newX = Math.floor(e);
                        thumb.newY = Math.floor(t);
                        thumb.setScale(n, 1);
                        ...
                        e = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * s;
                        n = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                        thumb.setScale(n);
                        e *= i.sizeRatio;
                        var o = i.thumbHeight / i.thumbWidth;
                        if (o > .7) {
                            e *= Math.min(1 / o, .8)
                        }
                        if (i.data.thumbsAlignment == "bottom") {
            ...
            this.sortZ = function () {
                ...
                if (a > i.totalThumbs / 2 && i.topology != "flipping" && FWDUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                    for (var r = 0; r < i.totalThumbs; r++) {
                        thumb = i.thumbsAr[r];
            ...
            this.setupControls = function () {
                i.controlsDO = new FWDDisplayObject3D("div");
            ...
            this.setupPrevButton = function () {
                FWDSimpleButton.setPrototype();
                i.prevButtonDO = new FWDSimpleButton(i.data.prevButtonNImg, i.data.prevButtonSImg);
                i.prevButtonDO.addListener(FWDSimpleButton.CLICK, i.prevButtonOnClickHandler);
            ...
            this.setupNextButton = function () {
                FWDSimpleButton.setPrototype();
                i.nextButtonDO = new FWDSimpleButton(i.data.nextButtonNImg, i.data.nextButtonSImg);
                i.nextButtonDO.addListener(FWDSimpleButton.CLICK, i.nextButtonOnClickHandler);
            ...
            this.setPreset = function (e) {
                ...
                i.reflDist = e[8];
                i.showGradient = e[9];
                TweenMax.to(i.thumbsHolderDO, .8, {
                    angleX: e[10],
                    angleY: e[11],
                    ease: Quart.easeOut
                });
            ...
            this.destroy = function () {
                ...
                if (i.imageLeft) {
                    i.imageLeft.onload = null;
                    i.imageLeft.onerror = null;
                    i.imageLeft.src = null
                }
                if (i.imageRight) {
                    i.imageRight.onload = null;
                    i.imageRight.onerror = null;
                    i.imageRight.src = null
                }
                i.image = null;
                i.imageLeft = null;
                i.imageRight = null;
                for (var n = 0; n < i.totalThumbs; n++) {
                    TweenMax.killTweensOf(i.thumbsAr[n]);
                ...
                if (i.controlsDO) {
                    TweenMax.killTweensOf(i.controlsDO);
...
(function (e) {
    var t = function (n) {
            ...
            this.init = function () {
                ...
                if (!FWDUtils.getChildById(r.propsObj.coverflowHolderDivId)) {
                ...
                r.stageContainer = FWDUtils.getChildById(r.propsObj.coverflowHolderDivId);
            ...
            this.setupMainDO = function () {
                r.mainDO = new FWDDisplayObject("div", "relative");
            ...
            this.setBackgrounds = function () {
                if (r.propsObj.backgroundImagePath) {
                    r.bgDO = new FWDDisplayObject("div");
            ...
            this.setupContextMenu = function () {
                r.customContextMenuDO = new FWDContextMenu(r.mainDO, r.data.showContextMenu)
            };
            ...
            this.setupPreloader = function () {
                FWDPreloader.setPrototype();
                r.preloaderDO = new FWDPreloader(r.data.mainPreloaderImg, 85, 36, 20, 50);
            ...
            this.positionPreloader = function () {
                if (r.preloaderDO) {
                    ...
                    if (r.data.controlsPos) {
                        r.preloaderDO.setY(parseInt((r.stageHeight - r.preloaderDO.getHeight() - r.data.nextButtonNImg.height) / 2 + r.data.nextButtonNImg.height) + 7)
                    } else {
                        r.preloaderDO.setY(parseInt((r.stageHeight - r.preloaderDO.getHeight() - r.data.nextButtonNImg.height) / 2) + 7)
                    }
                }
            };
            ...
            this.setupDisable = function () {
                r.disableDO = new FWDDisplayObject3D("div");
...
(function (e) {
    var t = function (e) {
            ...
            this.setupText = function () {
                n.tooltipMainDO = new FWDDisplayObject("div");
                n.addChild(n.tooltipMainDO);
                n.tooltipHolderDO = new FWDDisplayObject("div");
                n.tooltipMainDO.addChild(n.tooltipHolderDO);
                n.tooltipHolderDO.setWidth(1e3);
                n.tooltipTextDO = new FWDSimpleDisplayObject("div");
            ...
            this.setupTooltip = function () {
                n.tooltipCenterDO = new FWDSimpleDisplayObject("img");
                ...
                n.tooltipTopDO = new FWDSimpleDisplayObject("img");
                ...
                n.tooltipLeftDO = new FWDSimpleDisplayObject("img");
                ...
                n.tooltipRightDO = new FWDSimpleDisplayObject("img");
                ...
                n.tooltipBottomDO = new FWDSimpleDisplayObject("img");
            ...
            this.onPointerBottomLoad = function () {
                n.tooltipPointerBottomDO = new FWDSimpleDisplayObject("img");
            ...
            this.onPointerTopLoad = function () {
                n.tooltipPointerTopDO = new FWDSimpleDisplayObject("img");
                ...
                n.tooltipOverDO = new FWDDisplayObject("div");
    ...
    t.setPrototype = function () {
        t.prototype = new FWDDisplayObject("div", "absolute", "visible")
    };
    t.CHANGE = "onChange";
    t.prototype = null;
    e.FWDTooltip = t
